...
{
    DHClockCell *clock = [collectionView dequeueReusableCellWithReuseIdentifier:@"ClockCell" forIndexPath:indexPath];
    
    clock.timestamp = [[self.fetchedResultsController objectAtIndexPath:indexPath] valueForKey:@"timeStamp"];
    return clock;
}
